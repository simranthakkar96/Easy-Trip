...
public class Login extends AppCompatActivity {
       ...
       /* forgot.setOnClickListener(new View.OnClickListener() {
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag==0)
                {
                    //show.setColorFilter(ContextCompat.getColor(Login.this,R.color.colorPrimary));
                ...
                {
                   // show.setColorFilter(ContextCompat.getColor(Login.this,R.color.white));
    ...
    class xyz extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                response = run(url+"action=getlogin_information&uname=" + uname.getText().toString() + "&password=" + pass.getText().toString()+"&token="+ sharedpreference.getfirebasetoken(Login.this));
            } catch (IOException e) {
                e.printStackTrace();
            }
