...
public class Registration extends AppCompatActivity
{
    ...
    class abc extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                response = run(url+"action=registration&fname=" + fname.getText().toString() + "&lname=" + lname.getText().toString() + "&pass=" + pass.getText().toString() + "&cpass=" + cpass.getText().toString() + "&email=" + email.getText().toString() + "&mobile=" + number.getText().toString());
            } catch (IOException e) {
                e.printStackTrace();
            }
